...
class DDEX::ERN::V38::Image < Element
  ...
  xml_name "Image"
      ...
      xml_accessor :image_ids, :as => [DDEX::ERN::V38::ResourceProprietaryId], :from => "ImageId", :required => true
      ...
      xml_accessor :image_details_by_territories, :as => [DDEX::ERN::V38::ImageDetailsByTerritory], :from => "ImageDetailsByTerritory", :required => true
