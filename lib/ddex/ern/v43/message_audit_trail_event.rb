...
class DDEX::ERN::V43::MessageAuditTrailEvent < Element
  include ROXML


  xml_name "MessageAuditTrailEvent"

      xml_accessor :messaging_party_descriptor, :as => DDEX::ERN::V43::MessagingPartyWithoutCode, :from => "MessagingPartyDescriptor", :required => true
