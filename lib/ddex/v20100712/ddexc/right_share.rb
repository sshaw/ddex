...
require "ddex/v20100712/ddexc/right_share_creation_reference_list"
...
require "ddex/v20100712/ddexc/tariff_reference"
...
class DDEX::V20100712::DDEXC::RightShare < Element
  include ROXML
  ...
  xml_name "RightShare"
      ...
      xml_accessor :right_share_creation_reference_list, :as => DDEX::V20100712::DDEXC::RightShareCreationReferenceList, :from => "RightShareCreationReferenceList", :required => false
      xml_accessor :excluded_territory_codes, :as => [], :from => "ExcludedTerritoryCode", :required => false
      xml_accessor :territory_codes, :as => [], :from => "TerritoryCode", :required => false
      xml_accessor :rights_types, :as => [DDEX::V20100712::DDEXC::RightsType], :from => "RightsType", :required => false
      xml_accessor :use_types, :as => [DDEX::V20100712::DDEXC::UseType], :from => "UseType", :required => false
      ...
      xml_accessor :validity_period, :as => DDEX::V20100712::DDEXC::Period, :from => "ValidityPeriod", :required => true
      ...
      xml_accessor :tariff_reference, :as => DDEX::V20100712::DDEXC::TariffReference, :from => "TariffReference", :required => false
