...
require "ddex/ern/v35/technical_video_details"
...
class VideoDetailsByTerritory < Element
  ...
  xml_name "VideoDetailsByTerritory"
      ...
      xml_accessor :technical_video_details, :as => [DDEX::ERN::V35::TechnicalVideoDetails], :from => "TechnicalVideoDetails", :required => false
