...
class DDEX::ERN::V38::MidiDetailsByTerritory < Element
  ...
  xml_name "ns1:MidiDetailsByTerritory"
      ...
      xml_accessor :technical_midi_details, :as => [DDEX::ERN::V38::TechnicalMidiDetails], :from => "TechnicalMidiDetails", :required => false
