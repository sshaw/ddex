...
class SoundRecording < Element
  ...
  xml_name "SoundRecording"
      ...
      xml_accessor :sound_recording_details_by_territories, :as => [DDEX::V20110630::DDEXC::SoundRecordingDetailsByTerritory], :from => "SoundRecordingDetailsByTerritory", :required => true
