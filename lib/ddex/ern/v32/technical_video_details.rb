...
class DDEX::ERN::V32::TechnicalVideoDetails < Element
  ...
  xml_name "ns1:TechnicalVideoDetails"
      ...
      xml_accessor :overall_bit_rate, :as => DDEX::V20100712::DDEXC::BitRate, :from => "OverallBitRate", :required => false
      xml_accessor :video_codec_type, :as => DDEX::V20100712::DDEXC::VideoCodecType, :from => "VideoCodecType", :required => false
      xml_accessor :video_bit_rate, :as => DDEX::V20100712::DDEXC::BitRate, :from => "VideoBitRate", :required => false
      xml_accessor :frame_rate, :as => DDEX::V20100712::DDEXC::FrameRate, :from => "FrameRate", :required => false
      xml_accessor :image_height, :as => DDEX::V20100712::DDEXC::Extent, :from => "ImageHeight", :required => false
      xml_accessor :image_width, :as => DDEX::V20100712::DDEXC::Extent, :from => "ImageWidth", :required => false
      ...
      xml_accessor :audio_bit_rate, :as => DDEX::V20100712::DDEXC::BitRate, :from => "AudioBitRate", :required => false
      xml_accessor :number_of_audio_channels, :as => Integer, :from => "NumberOfAudioChannels", :required => false
      xml_accessor :audio_sampling_rate, :as => DDEX::V20100712::DDEXC::SamplingRate, :from => "AudioSamplingRate", :required => false
