...
require "ddex/v20120214/ddexc/collection_details_by_territory"
require "ddex/v20120214/ddexc/collection_id"
require "ddex/v20120214/ddexc/collection_resource_reference_list"
...
class Collection < Element
  ...
  xml_name "Collection"
      ...
      xml_accessor :collection_details_by_territories, :as => [DDEX::V20120214::DDEXC::CollectionDetailsByTerritory], :from => "CollectionDetailsByTerritory", :required => false

      xml_accessor :collection_resource_reference_list, :as => DDEX::V20120214::DDEXC::CollectionResourceReferenceList, :from => "CollectionResourceReferenceList", :required => false
