...
require "ddex/ern/v38/technical_sheet_music_details"
require "ddex/ern/v38/title"

module DDEX module ERN module V38  # :nodoc: all

class DDEX::ERN::V38::SheetMusicDetailsByTerritory < Element
  include ROXML
  ...
  xml_name "SheetMusicDetailsByTerritory"
      ...
      xml_accessor :technical_sheet_music_details, :as => [DDEX::ERN::V38::TechnicalSheetMusicDetails], :from => "TechnicalSheetMusicDetails", :required => false
