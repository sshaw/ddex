...
require "ddex/v20100712/ddexc/musical_work_details_by_territory"
require "ddex/v20100712/ddexc/musical_work_id"
require "ddex/v20100712/ddexc/musical_work_type"
require "ddex/v20100712/ddexc/reference_title"
require "ddex/v20100712/ddexc/right_share"
require "ddex/v20100712/ddexc/rights_agreement_id"

module DDEX module V20100712 module DDEXC  # :nodoc: all

class DDEX::V20100712::DDEXC::MusicalWork < Element
  include ROXML
  ...
  xml_name "MusicalWork"
      ...
      xml_accessor :reference_titles, :as => [DDEX::V20100712::DDEXC::ReferenceTitle], :from => "ReferenceTitle", :required => true
      ...
      xml_accessor :musical_work_types, :as => [DDEX::V20100712::DDEXC::MusicalWorkType], :from => "MusicalWorkType", :required => false
      xml_accessor :right_shares, :as => [DDEX::V20100712::DDEXC::RightShare], :from => "RightShare", :required => false
