...
require "ddex/ern/v382/sound_recording_details_by_territory"
require "ddex/ern/v382/sound_recording_id"
require "ddex/ern/v382/sound_recording_type"

module DDEX module ERN module V382  # :nodoc: all

class DDEX::ERN::V382::SoundRecording < Element
  include ROXML


  xml_name "SoundRecording"

      xml_accessor :sound_recording_type, :as => DDEX::ERN::V382::SoundRecordingType, :from => "SoundRecordingType", :required => false
      xml_accessor :artist_related?, :from => "IsArtistRelated", :required => false
      xml_accessor :sound_recording_ids, :as => [DDEX::ERN::V382::SoundRecordingId], :from => "SoundRecordingId", :required => true
      xml_accessor :indirect_sound_recording_ids, :as => [DDEX::ERN::V382::MusicalWorkId], :from => "IndirectSoundRecordingId", :required => false
      ...
      xml_accessor :sound_recording_collection_reference_list, :as => DDEX::ERN::V382::SoundRecordingCollectionReferenceList, :from => "SoundRecordingCollectionReferenceList", :required => false
      ...
      xml_accessor :sound_recording_details_by_territories, :as => [DDEX::ERN::V382::SoundRecordingDetailsByTerritory], :from => "SoundRecordingDetailsByTerritory", :required => true
