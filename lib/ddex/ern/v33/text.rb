...
require "ddex/ern/v33/text_details_by_territory"
...
require "ddex/v20110630/ddexc/text_id"
require "ddex/v20110630/ddexc/text_type"
...
class Text < Element
  ...
  xml_name "Text"
      ...
      xml_accessor :text_type, :as => DDEX::V20110630::DDEXC::TextType, :from => "TextType", :required => false

      xml_accessor :artist_related?, :from => "IsArtistRelated", :required => false

      
      xml_accessor :text_ids, :as => [DDEX::V20110630::DDEXC::TextId], :from => "TextId", :required => false

      
      xml_accessor :indirect_text_ids, :as => [DDEX::V20110630::DDEXC::MusicalWorkId], :from => "IndirectTextId", :required => false
      ...
      xml_accessor :text_details_by_territories, :as => [DDEX::ERN::V33::TextDetailsByTerritory], :from => "TextDetailsByTerritory", :required => true
