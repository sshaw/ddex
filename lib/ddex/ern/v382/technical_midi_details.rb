...
class DDEX::ERN::V382::TechnicalMidiDetails < Element
  ...
  xml_name "TechnicalMidiDetails"
      ...
      xml_accessor :sound_processor_type, :as => DDEX::ERN::V382::SoundProcessorType, :from => "SoundProcessorType", :required => false
