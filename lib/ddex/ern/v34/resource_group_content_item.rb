...
require "ddex/v20120214/ddexc/linked_release_resource_reference"
require "ddex/v20120214/ddexc/release_id"
require "ddex/v20120214/ddexc/release_resource_reference"
require "ddex/v20120214/ddexc/resource_type"
...
class ResourceGroupContentItem < Element
  ...
  xml_name "ResourceGroupContentItem"
      ...
      xml_accessor :resource_types, :as => [DDEX::V20120214::DDEXC::ResourceType], :from => "ResourceType", :required => false

      xml_accessor :release_resource_reference, :as => DDEX::V20120214::DDEXC::ReleaseResourceReference, :from => "ReleaseResourceReference", :required => true

      
      xml_accessor :linked_release_resource_references, :as => [DDEX::V20120214::DDEXC::LinkedReleaseResourceReference], :from => "LinkedReleaseResourceReference", :required => false
