...
require "ddex/ern/v34/technical_sheet_music_details"
...
class SheetMusicDetailsByTerritory < Element
  ...
  xml_name "SheetMusicDetailsByTerritory"
      ...
      xml_accessor :technical_sheet_music_details, :as => [DDEX::ERN::V34::TechnicalSheetMusicDetails], :from => "TechnicalSheetMusicDetails", :required => false
