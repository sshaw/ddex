...
class DDEX::ERN::V38::VideoDetailsByTerritory < Element
  ...
  xml_name "VideoDetailsByTerritory"
      ...
      xml_accessor :technical_video_details, :as => [DDEX::ERN::V38::TechnicalVideoDetails], :from => "TechnicalVideoDetails", :required => false
