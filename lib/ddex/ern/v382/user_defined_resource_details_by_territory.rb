...
require "ddex/ern/v382/technical_user_defined_resource_details"
require "ddex/ern/v382/title"
require "ddex/ern/v382/user_defined_value"

module DDEX module ERN module V382  # :nodoc: all

class DDEX::ERN::V382::UserDefinedResourceDetailsByTerritory < Element
  include ROXML
  ...
  xml_name "UserDefinedResourceDetailsByTerritory"
      ...
      xml_accessor :technical_user_defined_resource_details, :as => [DDEX::ERN::V382::TechnicalUserDefinedResourceDetails], :from => "TechnicalUserDefinedResourceDetails", :required => false
