...
require "ddex/ern/v383/user_defined_resource_details_by_territory"
require "ddex/ern/v383/user_defined_resource_type"
require "ddex/ern/v383/user_defined_value"

module DDEX module ERN module V383  # :nodoc: all

class DDEX::ERN::V383::UserDefinedResource < Element
  include ROXML


  xml_name "UserDefinedResource"

      xml_accessor :user_defined_resource_type, :as => DDEX::ERN::V383::UserDefinedResourceType, :from => "UserDefinedResourceType", :required => false
      xml_accessor :artist_related?, :from => "IsArtistRelated", :required => false
      xml_accessor :user_defined_resource_ids, :as => [DDEX::ERN::V383::ResourceProprietaryId], :from => "UserDefinedResourceId", :required => true
      xml_accessor :indirect_user_defined_resource_ids, :as => [DDEX::ERN::V383::MusicalWorkId], :from => "IndirectUserDefinedResourceId", :required => false
      ...
      xml_accessor :user_defined_resource_details_by_territories, :as => [DDEX::ERN::V383::UserDefinedResourceDetailsByTerritory], :from => "UserDefinedResourceDetailsByTerritory", :required => true
