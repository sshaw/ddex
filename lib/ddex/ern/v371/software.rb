...
require "ddex/ern/v371/software_details_by_territory"
require "ddex/ern/v371/software_type"
...
class Software < Element
  ...
  xml_name "Software"
      ...
      xml_accessor :software_ids, :as => [ResourceProprietaryId], :from => "SoftwareId", :required => true
