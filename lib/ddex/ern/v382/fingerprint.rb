...
require "ddex/ern/v382/fingerprint_algorithm_type"

module DDEX module ERN module V382  # :nodoc: all

class DDEX::ERN::V382::Fingerprint < Element
  include ROXML
  ...
  xml_name "Fingerprint"
      ...
      xml_accessor :fingerprint_algorithm_type, :as => DDEX::ERN::V382::FingerprintAlgorithmType, :from => "FingerprintAlgorithmType", :required => true
