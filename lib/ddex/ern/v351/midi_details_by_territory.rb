...
require "ddex/ern/v351/technical_midi_details"
...
class MidiDetailsByTerritory < Element
  ...
  xml_name "MidiDetailsByTerritory"
      ...
      xml_accessor :technical_midi_details, :as => [DDEX::ERN::V351::TechnicalMidiDetails], :from => "TechnicalMidiDetails", :required => false
