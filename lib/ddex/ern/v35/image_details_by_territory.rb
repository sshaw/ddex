...
require "ddex/ern/v35/technical_image_details"
...
class ImageDetailsByTerritory < Element
  ...
  xml_name "ImageDetailsByTerritory"
      ...
      xml_accessor :technical_image_details, :as => [DDEX::ERN::V35::TechnicalImageDetails], :from => "TechnicalImageDetails", :required => false
