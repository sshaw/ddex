...
require "ddex/ern/v382/sound_recording_collection_reference_list"
require "ddex/ern/v382/title"
require "ddex/ern/v382/video_cue_sheet_reference"
require "ddex/ern/v382/video_details_by_territory"
require "ddex/ern/v382/video_id"
require "ddex/ern/v382/video_type"

module DDEX module ERN module V382  # :nodoc: all

class DDEX::ERN::V382::Video < Element
  include ROXML


  xml_name "Video"

      xml_accessor :video_type, :as => DDEX::ERN::V382::VideoType, :from => "VideoType", :required => false
      xml_accessor :artist_related?, :from => "IsArtistRelated", :required => false
      xml_accessor :video_ids, :as => [DDEX::ERN::V382::VideoId], :from => "VideoId", :required => false
      xml_accessor :indirect_video_ids, :as => [DDEX::ERN::V382::MusicalWorkId], :from => "IndirectVideoId", :required => false
      xml_accessor :resource_reference, :from => "ResourceReference", :required => true
      xml_accessor :reason_for_cue_sheet_absence, :as => DDEX::ERN::V382::Reason, :from => "ReasonForCueSheetAbsence", :required => false
      xml_accessor :video_cue_sheet_references, :as => [DDEX::ERN::V382::VideoCueSheetReference], :from => "VideoCueSheetReference", :required => false
      ...
      xml_accessor :video_collection_reference_list, :as => DDEX::ERN::V382::SoundRecordingCollectionReferenceList, :from => "VideoCollectionReferenceList", :required => false
      ...
      xml_accessor :video_details_by_territories, :as => [DDEX::ERN::V382::VideoDetailsByTerritory], :from => "VideoDetailsByTerritory", :required => true
      xml_accessor :territory_of_commissioning, :as => DDEX::ERN::V382::AllTerritoryCode, :from => "TerritoryOfCommissioning", :required => false
