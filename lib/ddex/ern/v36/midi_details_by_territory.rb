...
require "ddex/ern/v36/technical_midi_details"
...
class MidiDetailsByTerritory < Element
  ...
  xml_name "MidiDetailsByTerritory"
      ...
      xml_accessor :technical_midi_details, :as => [DDEX::ERN::V36::TechnicalMidiDetails], :from => "TechnicalMidiDetails", :required => false
