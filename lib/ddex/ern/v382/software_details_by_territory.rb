...
require "ddex/ern/v382/technical_software_details"
require "ddex/ern/v382/title"

module DDEX module ERN module V382  # :nodoc: all

class DDEX::ERN::V382::SoftwareDetailsByTerritory < Element
  include ROXML
  ...
  xml_name "SoftwareDetailsByTerritory"
      ...
      xml_accessor :technical_software_details, :as => [DDEX::ERN::V382::TechnicalSoftwareDetails], :from => "TechnicalSoftwareDetails", :required => false
