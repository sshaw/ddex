...
require "ddex/v20100712/ddexc/release_relationship_type"
...
class DDEX::V20100712::DDEXC::RelatedRelease < Element
  include ROXML
  ...
  xml_name "RelatedRelease"
      ...
      xml_accessor :release_relationship_type, :as => DDEX::V20100712::DDEXC::ReleaseRelationshipType, :from => "ReleaseRelationshipType", :required => true
      xml_accessor :release_date, :as => DDEX::V20100712::DDEXC::EventDate, :from => "ReleaseDate", :required => false
