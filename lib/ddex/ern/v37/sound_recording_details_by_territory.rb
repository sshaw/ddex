...
require "ddex/ern/v37/technical_sound_recording_details"
...
class SoundRecordingDetailsByTerritory < Element
  ...
  xml_name "SoundRecordingDetailsByTerritory"
      ...
      xml_accessor :technical_sound_recording_details, :as => [DDEX::ERN::V37::TechnicalSoundRecordingDetails], :from => "TechnicalSoundRecordingDetails", :required => false
