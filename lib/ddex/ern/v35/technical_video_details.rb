...
require "ddex/v20120719/ddexc/audio_codec_type"
require "ddex/v20120719/ddexc/bit_rate"
require "ddex/v20120719/ddexc/bit_rate"
require "ddex/v20120719/ddexc/bit_rate"
...
class TechnicalVideoDetails < Element
  ...
  xml_name "TechnicalVideoDetails"
      ...
      xml_accessor :overall_bit_rate, :as => DDEX::V20120719::DDEXC::BitRate, :from => "OverallBitRate", :required => false

      xml_accessor :container_format, :as => DDEX::V20120719::DDEXC::ContainerFormat, :from => "ContainerFormat", :required => false

      xml_accessor :video_codec_type, :as => DDEX::V20120719::DDEXC::VideoCodecType, :from => "VideoCodecType", :required => false

      xml_accessor :video_bit_rate, :as => DDEX::V20120719::DDEXC::BitRate, :from => "VideoBitRate", :required => false

      xml_accessor :frame_rate, :as => DDEX::V20120719::DDEXC::FrameRate, :from => "FrameRate", :required => false

      xml_accessor :image_height, :as => DDEX::V20120719::DDEXC::Extent, :from => "ImageHeight", :required => false

      xml_accessor :image_width, :as => DDEX::V20120719::DDEXC::Extent, :from => "ImageWidth", :required => false
      ...
      xml_accessor :audio_codec_type, :as => DDEX::V20120719::DDEXC::AudioCodecType, :from => "AudioCodecType", :required => false

      xml_accessor :audio_bit_rate, :as => DDEX::V20120719::DDEXC::BitRate, :from => "AudioBitRate", :required => false

      xml_accessor :number_of_audio_channels, :as => Fixnum, :from => "NumberOfAudioChannels", :required => false

      xml_accessor :audio_sampling_rate, :as => DDEX::V20120719::DDEXC::SamplingRate, :from => "AudioSamplingRate", :required => false
