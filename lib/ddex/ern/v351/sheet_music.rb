...
require "ddex/ern/v351/sheet_music_details_by_territory"
...
require "ddex/v20121219/ddexc/sheet_music_id"
require "ddex/v20121219/ddexc/sheet_music_type"
...
class SheetMusic < Element
  ...
  xml_name "SheetMusic"
      ...
      xml_accessor :sheet_music_type, :as => DDEX::V20121219::DDEXC::SheetMusicType, :from => "SheetMusicType", :required => false

      xml_accessor :artist_related?, :from => "IsArtistRelated", :required => false

      
      xml_accessor :sheet_music_ids, :as => [DDEX::V20121219::DDEXC::SheetMusicId], :from => "SheetMusicId", :required => true

      
      xml_accessor :indirect_sheet_music_ids, :as => [DDEX::V20121219::DDEXC::MusicalWorkId], :from => "IndirectSheetMusicId", :required => false
      ...
      xml_accessor :sheet_music_details_by_territories, :as => [DDEX::ERN::V351::SheetMusicDetailsByTerritory], :from => "SheetMusicDetailsByTerritory", :required => true
