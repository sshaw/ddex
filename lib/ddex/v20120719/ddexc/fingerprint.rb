...
require "ddex/v20120719/ddexc/fingerprint_algorithm_type"
...
class Fingerprint < Element
  ...
  xml_name "Fingerprint"
      ...
      xml_accessor :fingerprint_algorithm_type, :as => DDEX::V20120719::DDEXC::FingerprintAlgorithmType, :from => "FingerprintAlgorithmType", :required => true
