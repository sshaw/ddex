...
class DDEX::ERN::V38::TypedRightsController < Element
  include ROXML
  ...
  xml_name "ns1:TypedRightsController"
      ...
      xml_accessor :territory_of_registration, :as => DDEX::ERN::V38::AllTerritoryCode, :from => "TerritoryOfRegistration", :required => false
