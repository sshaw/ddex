...
require "ddex/ern/v38/linked_release_resource_reference"
require "ddex/ern/v38/release_id"
require "ddex/ern/v38/release_resource_reference"
require "ddex/ern/v38/resource_type"

module DDEX module ERN module V38  # :nodoc: all

class DDEX::ERN::V38::ExtendedResourceGroupContentItem < Element
  include ROXML
  ...
  xml_name "ExtendedResourceGroupContentItem"
      ...
      xml_accessor :resource_types, :as => [DDEX::ERN::V38::ResourceType], :from => "ResourceType", :required => false
      xml_accessor :release_resource_reference, :as => DDEX::ERN::V38::ReleaseResourceReference, :from => "ReleaseResourceReference", :required => true
      xml_accessor :linked_release_resource_references, :as => [DDEX::ERN::V38::LinkedReleaseResourceReference], :from => "LinkedReleaseResourceReference", :required => false
