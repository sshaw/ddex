...
require "ddex/ern/v33/software_details_by_territory"
...
class Software < Element
  ...
  xml_name "Software"
      ...
      xml_accessor :software_details_by_territories, :as => [DDEX::ERN::V33::SoftwareDetailsByTerritory], :from => "SoftwareDetailsByTerritory", :required => true
