...
require "ddex/v20120214/ddexc/resource_contributor_role"
...
class ResourceContributor < Element
  ...
  xml_name "ResourceContributor"
      ...
      xml_accessor :resource_contributor_roles, :as => [DDEX::V20120214::DDEXC::ResourceContributorRole], :from => "ResourceContributorRole", :required => false
