...
require "ddex/ern/v36/technical_video_details"
...
class VideoDetailsByTerritory < Element
  ...
  xml_name "VideoDetailsByTerritory"
      ...
      xml_accessor :technical_video_details, :as => [DDEX::ERN::V36::TechnicalVideoDetails], :from => "TechnicalVideoDetails", :required => false
