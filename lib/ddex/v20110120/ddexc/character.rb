...
class DDEX::V20110120::DDEXC::Character < DDEX::V20110120::DDEXC::PartyDescriptor
  include ROXML


  xml_name "Character"

      xml_accessor :resource_contributor, :as => DDEX::V20110120::DDEXC::ResourceContributor, :from => "ResourceContributor", :required => false
