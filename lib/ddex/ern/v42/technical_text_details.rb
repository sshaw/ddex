...
require "ddex/ern/v42/text_codec_type"

module DDEX module ERN module V42  # :nodoc: all

class DDEX::ERN::V42::TechnicalTextDetails < Element
  include ROXML
  ...
  xml_name "TechnicalTextDetails"
      ...
      xml_accessor :text_codec_type, :as => DDEX::ERN::V42::TextCodecType, :from => "TextCodecType", :required => false
