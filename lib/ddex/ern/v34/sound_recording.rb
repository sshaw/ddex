...
require "ddex/ern/v34/sound_recording_details_by_territory"
...
class SoundRecording < Element
  ...
  xml_name "SoundRecording"
      ...
      xml_accessor :sound_recording_type, :as => DDEX::V20120214::DDEXC::SoundRecordingType, :from => "SoundRecordingType", :required => false

      xml_accessor :artist_related?, :from => "IsArtistRelated", :required => false

      
      xml_accessor :sound_recording_ids, :as => [DDEX::V20120214::DDEXC::SoundRecordingId], :from => "SoundRecordingId", :required => true

      
      xml_accessor :indirect_sound_recording_ids, :as => [DDEX::V20120214::DDEXC::MusicalWorkId], :from => "IndirectSoundRecordingId", :required => false
      ...
      xml_accessor :sound_recording_collection_reference_list, :as => DDEX::V20120214::DDEXC::SoundRecordingCollectionReferenceList, :from => "SoundRecordingCollectionReferenceList", :required => false
      ...
      xml_accessor :sound_recording_details_by_territories, :as => [DDEX::ERN::V34::SoundRecordingDetailsByTerritory], :from => "SoundRecordingDetailsByTerritory", :required => true
