...
require "ddex/ern/v312/sound_recording_details_by_territory"
...
require "ddex/v20100121/ddexc/sound_recording_type"
...
class SoundRecording < Element
  ...
  xml_name "ns1:SoundRecording"
      ...
      xml_accessor :sound_recording_type, :as => DDEX::V20100121::DDEXC::SoundRecordingType, :from => "SoundRecordingType", :required => false
      xml_accessor :artist_related?, :from => "IsArtistRelated", :required => false
      xml_accessor :sound_recording_ids, :as => [DDEX::V20100121::DDEXC::SoundRecordingId], :from => "SoundRecordingId", :required => true
      ...
      xml_accessor :sound_recording_collection_reference_list, :as => DDEX::V20100121::DDEXC::SoundRecordingCollectionReferenceList, :from => "SoundRecordingCollectionReferenceList", :required => false
