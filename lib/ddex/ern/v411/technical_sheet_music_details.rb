...
require "ddex/ern/v411/sheet_music_codec_type"

module DDEX module ERN module V411  # :nodoc: all

class DDEX::ERN::V411::TechnicalSheetMusicDetails < Element
  include ROXML
  ...
  xml_name "TechnicalSheetMusicDetails"
      ...
      xml_accessor :sheet_music_codec_type, :as => DDEX::ERN::V411::SheetMusicCodecType, :from => "SheetMusicCodecType", :required => false
