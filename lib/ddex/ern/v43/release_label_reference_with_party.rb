...
class DDEX::ERN::V43::ReleaseLabelReferenceWithParty < Element
  include ROXML


  xml_name "ReleaseLabelReferenceWithParty"
    ...
    xml_accessor :value, :from => ".", :required => false
      ...
      xml_accessor :access_control_party, :from => "@AccessControlParty", :required => false
