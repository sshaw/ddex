...
class DDEX::ERN::V382::VideoDetailsByTerritory < Element
  ...
  xml_name "VideoDetailsByTerritory"
      ...
      xml_accessor :technical_video_details, :as => [DDEX::ERN::V382::TechnicalVideoDetails], :from => "TechnicalVideoDetails", :required => false
