...
require "ddex/ern/v351/midi_details_by_territory"
require "ddex/v20121219/ddexc/description"
require "ddex/v20121219/ddexc/event_date"
require "ddex/v20121219/ddexc/event_date"
require "ddex/v20121219/ddexc/midi_id"
require "ddex/v20121219/ddexc/midi_type"
...
class MIDI < Element
  ...
  xml_name "MIDI"
      ...
      xml_accessor :midi_type, :as => DDEX::V20121219::DDEXC::MidiType, :from => "MidiType", :required => false

      xml_accessor :artist_related?, :from => "IsArtistRelated", :required => false

      
      xml_accessor :midi_ids, :as => [DDEX::V20121219::DDEXC::MidiId], :from => "MidiId", :required => true

      
      xml_accessor :indirect_midi_ids, :as => [DDEX::V20121219::DDEXC::MusicalWorkId], :from => "IndirectMidiId", :required => false
      ...
      xml_accessor :midi_details_by_territories, :as => [DDEX::ERN::V351::MidiDetailsByTerritory], :from => "MidiDetailsByTerritory", :required => true
