...
class UserDefinedResource < Element
  ...
  xml_name "UserDefinedResource"
      ...
      xml_accessor :user_defined_resource_details_by_territories, :as => [DDEX::V20110630::DDEXC::UserDefinedResourceDetailsByTerritory], :from => "UserDefinedResourceDetailsByTerritory", :required => true
