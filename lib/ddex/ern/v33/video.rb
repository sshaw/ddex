...
require "ddex/ern/v33/video_details_by_territory"
...
require "ddex/v20110630/ddexc/reason"
...
require "ddex/v20110630/ddexc/video_cue_sheet_reference"
require "ddex/v20110630/ddexc/video_id"
require "ddex/v20110630/ddexc/video_type"
...
class Video < Element
  ...
  xml_name "Video"
      ...
      xml_accessor :video_type, :as => DDEX::V20110630::DDEXC::VideoType, :from => "VideoType", :required => false

      xml_accessor :artist_related?, :from => "IsArtistRelated", :required => false

      
      xml_accessor :video_ids, :as => [DDEX::V20110630::DDEXC::VideoId], :from => "VideoId", :required => false

      
      xml_accessor :indirect_video_ids, :as => [DDEX::V20110630::DDEXC::MusicalWorkId], :from => "IndirectVideoId", :required => false

      xml_accessor :resource_reference, :from => "ResourceReference", :required => true

      xml_accessor :reason_for_cue_sheet_absence, :as => DDEX::V20110630::DDEXC::Reason, :from => "ReasonForCueSheetAbsence", :required => false

      
      xml_accessor :video_cue_sheet_references, :as => [DDEX::V20110630::DDEXC::VideoCueSheetReference], :from => "VideoCueSheetReference", :required => false

      xml_accessor :reference_title, :as => DDEX::V20110630::DDEXC::ReferenceTitle, :from => "ReferenceTitle", :required => false
      ...
      xml_accessor :video_collection_reference_list, :as => DDEX::V20110630::DDEXC::SoundRecordingCollectionReferenceList, :from => "VideoCollectionReferenceList", :required => false
      ...
      xml_accessor :video_details_by_territories, :as => [DDEX::ERN::V33::VideoDetailsByTerritory], :from => "VideoDetailsByTerritory", :required => true
