...
require "ddex/ern/v38/sound_recording_details_by_territory"
require "ddex/ern/v38/sound_recording_id"
require "ddex/ern/v38/sound_recording_type"

module DDEX module ERN module V38  # :nodoc: all

class DDEX::ERN::V38::SoundRecording < Element
  include ROXML
  ...
  xml_name "SoundRecording"
      ...
      xml_accessor :sound_recording_ids, :as => [DDEX::ERN::V38::SoundRecordingId], :from => "SoundRecordingId", :required => true
      xml_accessor :indirect_sound_recording_ids, :as => [DDEX::ERN::V38::MusicalWorkId], :from => "IndirectSoundRecordingId", :required => false
      ...
      xml_accessor :sound_recording_collection_reference_list, :as => DDEX::ERN::V38::SoundRecordingCollectionReferenceList, :from => "SoundRecordingCollectionReferenceList", :required => false
      ...
      xml_accessor :sound_recording_details_by_territories, :as => [DDEX::ERN::V38::SoundRecordingDetailsByTerritory], :from => "SoundRecordingDetailsByTerritory", :required => true
