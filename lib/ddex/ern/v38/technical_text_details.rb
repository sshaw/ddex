...
require "ddex/ern/v38/text_codec_type"

module DDEX module ERN module V38  # :nodoc: all

class DDEX::ERN::V38::TechnicalTextDetails < Element
  include ROXML
  ...
  xml_name "ns1:TechnicalTextDetails"
      ...
      xml_accessor :text_codec_type, :as => DDEX::ERN::V38::TextCodecType, :from => "TextCodecType", :required => false
