...
class WebPage < Element
  ...
  xml_name "WebPage"
      ...
      xml_accessor :party_ids, :as => [DDEX::V20110630::DDEXC::PartyId], :from => "PartyId", :required => false

      
      xml_accessor :release_ids, :as => [DDEX::V20110630::DDEXC::ReleaseId], :from => "ReleaseId", :required => false

      xml_accessor :page_name, :as => DDEX::V20110630::DDEXC::Name, :from => "PageName", :required => false
