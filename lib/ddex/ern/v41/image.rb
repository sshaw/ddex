...
require "ddex/ern/v41/description_with_territory"
...
require "ddex/ern/v41/image_type"
...
class DDEX::ERN::V41::Image < Element
  ...
  xml_name "Image"
      ...
      xml_accessor :type, :as => DDEX::ERN::V41::ImageType, :from => "Type", :required => true
      xml_accessor :resource_ids, :as => [DDEX::ERN::V41::ResourceProprietaryId], :from => "ResourceId", :required => true
      ...
      xml_accessor :descriptions, :as => [DDEX::ERN::V41::DescriptionWithTerritory], :from => "Description", :required => false
      ...
      xml_accessor :technical_details, :as => [DDEX::ERN::V41::TechnicalImageDetails], :from => "TechnicalDetails", :required => false
