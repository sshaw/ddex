...
require "ddex/v20110120/ddexc/user_defined_resource_details_by_territory"
require "ddex/v20110120/ddexc/user_defined_resource_id"
require "ddex/v20110120/ddexc/user_defined_resource_type"
require "ddex/v20110120/ddexc/user_defined_value"

module DDEX module V20110120 module DDEXC  # :nodoc: all

class DDEX::V20110120::DDEXC::UserDefinedResource < Element
  include ROXML


  xml_name "UserDefinedResource"

      xml_accessor :user_defined_resource_type, :as => DDEX::V20110120::DDEXC::UserDefinedResourceType, :from => "UserDefinedResourceType", :required => false
      xml_accessor :artist_related?, :from => "IsArtistRelated", :required => false
      xml_accessor :user_defined_resource_ids, :as => [DDEX::V20110120::DDEXC::UserDefinedResourceId], :from => "UserDefinedResourceId", :required => true
      xml_accessor :indirect_user_defined_resource_ids, :as => [DDEX::V20110120::DDEXC::MusicalWorkId], :from => "IndirectUserDefinedResourceId", :required => false
      ...
      xml_accessor :user_defined_resource_details_by_territories, :as => [DDEX::V20110120::DDEXC::UserDefinedResourceDetailsByTerritory], :from => "UserDefinedResourceDetailsByTerritory", :required => true
