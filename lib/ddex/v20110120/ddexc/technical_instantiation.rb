...
require "ddex/v20110120/ddexc/bit_rate"

module DDEX module V20110120 module DDEXC  # :nodoc: all

class DDEX::V20110120::DDEXC::TechnicalInstantiation < Element
  include ROXML
  ...
  xml_name "TechnicalInstantiation"
      ...
      xml_accessor :bit_rate, :as => DDEX::V20110120::DDEXC::BitRate, :from => "BitRate", :required => false
