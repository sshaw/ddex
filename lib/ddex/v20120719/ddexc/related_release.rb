...
require "ddex/v20120719/ddexc/release_relationship_type"
...
class RelatedRelease < Element
  ...
  xml_name "RelatedRelease"
      ...
      xml_accessor :release_relationship_type, :as => DDEX::V20120719::DDEXC::ReleaseRelationshipType, :from => "ReleaseRelationshipType", :required => true
