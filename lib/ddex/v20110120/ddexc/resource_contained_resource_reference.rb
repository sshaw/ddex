...
require "ddex/v20110120/ddexc/purpose"

module DDEX module V20110120 module DDEXC  # :nodoc: all

class DDEX::V20110120::DDEXC::ResourceContainedResourceReference < Element
  include ROXML
  ...
  xml_name "ResourceContainedResourceReference"
      ...
      xml_accessor :purpose, :as => DDEX::V20110120::DDEXC::Purpose, :from => "Purpose", :required => false
