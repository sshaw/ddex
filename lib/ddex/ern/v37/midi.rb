...
require "ddex/ern/v37/midi_details_by_territory"
require "ddex/ern/v37/midi_type"
...
class MIDI < Element
  ...
  xml_name "MIDI"
      ...
      xml_accessor :midi_type, :as => DDEX::ERN::V37::MidiType, :from => "MidiType", :required => false
      xml_accessor :artist_related?, :from => "IsArtistRelated", :required => false
      xml_accessor :midi_ids, :as => [DDEX::ERN::V37::ResourceProprietaryId], :from => "MidiId", :required => true
      xml_accessor :indirect_midi_ids, :as => [DDEX::ERN::V37::MusicalWorkId], :from => "IndirectMidiId", :required => false
      ...
      xml_accessor :midi_details_by_territories, :as => [DDEX::ERN::V37::MidiDetailsByTerritory], :from => "MidiDetailsByTerritory", :required => true
