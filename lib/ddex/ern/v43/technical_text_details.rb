...
require "ddex/ern/v43/text_codec_type"

module DDEX module ERN module V43  # :nodoc: all

class DDEX::ERN::V43::TechnicalTextDetails < Element
  include ROXML
  ...
  xml_name "TechnicalTextDetails"
      ...
      xml_accessor :text_codec_type, :as => DDEX::ERN::V43::TextCodecType, :from => "TextCodecType", :required => false
