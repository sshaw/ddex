...
class SoundRecording < Element
  ...
  xml_name "ns2:SoundRecording"
      ...
      xml_accessor :sound_recording_details_by_territories, :as => [DDEX::V20100121::DDEXC::SoundRecordingDetailsByTerritory], :from => "SoundRecordingDetailsByTerritory", :required => true
