...
require "ddex/ern/v34/technical_text_details"
...
class TextDetailsByTerritory < Element
  ...
  xml_name "TextDetailsByTerritory"
      ...
      xml_accessor :technical_text_details, :as => [DDEX::ERN::V34::TechnicalTextDetails], :from => "TechnicalTextDetails", :required => false
