...
class ExternalResourceLink < Element
  ...
  xml_name "ExternalResourceLink"
      ...
      xml_accessor :validity_period, :as => DDEX::V20120404::DDEXC::Period, :from => "ValidityPeriod", :required => false

      xml_accessor :external_link, :from => "ExternalLink", :required => false

      
      xml_accessor :externally_linked_resource_types, :as => [DDEX::V20120404::DDEXC::ExternallyLinkedResourceType], :from => "ExternallyLinkedResourceType", :required => false
