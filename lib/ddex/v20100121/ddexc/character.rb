...
class Character < DDEX::V20100121::DDEXC::PartyDescriptor
  include ROXML


  xml_name "ns2:Character"

      xml_accessor :resource_contributor, :as => DDEX::V20100121::DDEXC::ResourceContributor, :from => "ResourceContributor", :required => false
