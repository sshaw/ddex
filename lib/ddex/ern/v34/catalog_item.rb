...
class CatalogItem < Element
  ...
  xml_name "CatalogItem"
      ...
      xml_accessor :title, :as => DDEX::V20120214::DDEXC::Title, :from => "Title", :required => true

      xml_accessor :display_artist_name, :as => DDEX::V20120214::DDEXC::Name, :from => "DisplayArtistName", :required => true

      
      xml_accessor :contributor_names, :as => [DDEX::V20120214::DDEXC::Name], :from => "ContributorName", :required => true

      xml_accessor :display_title, :as => DDEX::V20120214::DDEXC::ReferenceTitle, :from => "DisplayTitle", :required => true

      
      xml_accessor :label_names, :as => [DDEX::V20120214::DDEXC::LabelName], :from => "LabelName", :required => true
      ...
      xml_accessor :release_date, :as => DDEX::V20120214::DDEXC::EventDate, :from => "ReleaseDate", :required => true
