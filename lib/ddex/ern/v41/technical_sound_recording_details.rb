...
class DDEX::ERN::V41::TechnicalSoundRecordingDetails < Element
  include ROXML
  ...
  xml_name "TechnicalSoundRecordingDetails"
      ...
      xml_accessor :original_bit_rate, :as => DDEX::ERN::V41::BitRate, :from => "OriginalBitRate", :required => false
      xml_accessor :number_of_channels, :as => Integer, :from => "NumberOfChannels", :required => false
      xml_accessor :sampling_rate, :as => DDEX::ERN::V41::SamplingRate, :from => "SamplingRate", :required => false
      xml_accessor :original_sampling_rate, :as => DDEX::ERN::V41::SamplingRate, :from => "OriginalSamplingRate", :required => false
