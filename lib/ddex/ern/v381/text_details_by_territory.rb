...
require "ddex/ern/v381/technical_text_details"
require "ddex/ern/v381/title"

module DDEX module ERN module V381  # :nodoc: all

class DDEX::ERN::V381::TextDetailsByTerritory < Element
  include ROXML
  ...
  xml_name "ns1:TextDetailsByTerritory"
      ...
      xml_accessor :technical_text_details, :as => [DDEX::ERN::V381::TechnicalTextDetails], :from => "TechnicalTextDetails", :required => false
