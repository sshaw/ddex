...
require "ddex/ern/v382/text_codec_type"

module DDEX module ERN module V382  # :nodoc: all

class DDEX::ERN::V382::TechnicalTextDetails < Element
  include ROXML
  ...
  xml_name "TechnicalTextDetails"
      ...
      xml_accessor :text_codec_type, :as => DDEX::ERN::V382::TextCodecType, :from => "TextCodecType", :required => false
