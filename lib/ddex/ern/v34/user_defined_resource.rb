...
require "ddex/ern/v34/user_defined_resource_details_by_territory"
...
require "ddex/v20120214/ddexc/user_defined_resource_id"
require "ddex/v20120214/ddexc/user_defined_resource_type"
...
class UserDefinedResource < Element
  ...
  xml_name "UserDefinedResource"
      ...
      xml_accessor :user_defined_resource_type, :as => DDEX::V20120214::DDEXC::UserDefinedResourceType, :from => "UserDefinedResourceType", :required => false
      xml_accessor :artist_related?, :from => "IsArtistRelated", :required => false
      xml_accessor :user_defined_resource_ids, :as => [DDEX::V20120214::DDEXC::UserDefinedResourceId], :from => "UserDefinedResourceId", :required => true
      xml_accessor :indirect_user_defined_resource_ids, :as => [DDEX::V20120214::DDEXC::MusicalWorkId], :from => "IndirectUserDefinedResourceId", :required => false
      ...
      xml_accessor :user_defined_resource_details_by_territories, :as => [DDEX::ERN::V34::UserDefinedResourceDetailsByTerritory], :from => "UserDefinedResourceDetailsByTerritory", :required => true
