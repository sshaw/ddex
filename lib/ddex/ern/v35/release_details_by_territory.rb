...
require "ddex/v20120719/ddexc/related_release"
...
class ReleaseDetailsByTerritory < Element
  ...
  xml_name "ReleaseDetailsByTerritory"
      ...
      xml_accessor :display_artists, :as => [DDEX::V20120719::DDEXC::Artist], :from => "DisplayArtist", :required => true
      ...
      xml_accessor :related_releases, :as => [DDEX::V20120719::DDEXC::RelatedRelease], :from => "RelatedRelease", :required => false
      ...
      xml_accessor :release_date, :as => DDEX::V20120719::DDEXC::EventDate, :from => "ReleaseDate", :required => false

      xml_accessor :original_release_date, :as => DDEX::V20120719::DDEXC::EventDate, :from => "OriginalReleaseDate", :required => false

      xml_accessor :original_digital_release_date, :as => DDEX::V20120719::DDEXC::EventDate, :from => "OriginalDigitalReleaseDate", :required => false
