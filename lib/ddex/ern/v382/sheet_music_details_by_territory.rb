...
require "ddex/ern/v382/technical_sheet_music_details"
require "ddex/ern/v382/title"

module DDEX module ERN module V382  # :nodoc: all

class DDEX::ERN::V382::SheetMusicDetailsByTerritory < Element
  include ROXML
  ...
  xml_name "SheetMusicDetailsByTerritory"
      ...
      xml_accessor :technical_sheet_music_details, :as => [DDEX::ERN::V382::TechnicalSheetMusicDetails], :from => "TechnicalSheetMusicDetails", :required => false
