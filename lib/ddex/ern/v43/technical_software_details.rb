...
require "ddex/ern/v43/operating_system_type"

module DDEX module ERN module V43  # :nodoc: all

class DDEX::ERN::V43::TechnicalSoftwareDetails < Element
  include ROXML
  ...
  xml_name "TechnicalSoftwareDetails"
      ...
      xml_accessor :operating_system_type, :as => DDEX::ERN::V43::OperatingSystemType, :from => "OperatingSystemType", :required => false
