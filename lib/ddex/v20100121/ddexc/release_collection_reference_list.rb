...
require "ddex/v20100121/ddexc/release_collection_reference"
...
class ReleaseCollectionReferenceList < Element
  ...
  xml_name "ns2:ReleaseCollectionReferenceList"
      ...
      xml_accessor :release_collection_references, :as => [DDEX::V20100121::DDEXC::ReleaseCollectionReference], :from => "ReleaseCollectionReference", :required => true
