...
require "ddex/v20120214/ddexc/message_action_type"
require "ddex/v20120214/ddexc/product_type"
...
class ErnMessageInBatch < Element
  ...
  xml_name "ErnMessageInBatch"
      ...
      xml_accessor :included_release_ids, :as => [DDEX::V20120214::DDEXC::ReleaseId], :from => "IncludedReleaseId", :required => true
      xml_accessor :delivery_type, :as => DDEX::V20120214::DDEXC::MessageActionType, :from => "DeliveryType", :required => true
      xml_accessor :product_type, :as => DDEX::V20120214::DDEXC::ProductType, :from => "ProductType", :required => true
