...
require "ddex/ern/v33/midi_details_by_territory"
...
class MIDI < Element
  ...
  xml_name "MIDI"
      ...
      xml_accessor :midi_details_by_territories, :as => [DDEX::ERN::V33::MidiDetailsByTerritory], :from => "MidiDetailsByTerritory", :required => true
