...
require "ddex/v20120214/ddexc/right_share_creation_reference_list"
...
require "ddex/v20120214/ddexc/tariff_reference"
...
class RightShare < Element
  ...
  xml_name "RightShare"
      ...
      xml_accessor :right_share_id, :as => DDEX::V20120214::DDEXC::RightsAgreementId, :from => "RightShareId", :required => false

      xml_accessor :right_share_reference, :from => "RightShareReference", :required => true

      xml_accessor :right_share_creation_reference_list, :as => DDEX::V20120214::DDEXC::RightShareCreationReferenceList, :from => "RightShareCreationReferenceList", :required => false
      ...
      xml_accessor :rights_types, :as => [DDEX::V20120214::DDEXC::RightsType], :from => "RightsType", :required => false

      
      xml_accessor :use_types, :as => [DDEX::V20120214::DDEXC::UseType], :from => "UseType", :required => false
      ...
      xml_accessor :validity_period, :as => DDEX::V20120214::DDEXC::Period, :from => "ValidityPeriod", :required => true
      ...
      xml_accessor :tariff_reference, :as => DDEX::V20120214::DDEXC::TariffReference, :from => "TariffReference", :required => false
