...
require "ddex/v20120404/ddexc/fulfillment_date"
require "ddex/v20120404/ddexc/operating_system_type"
...
class TechnicalSoftwareDetails < Element
  ...
  xml_name "TechnicalSoftwareDetails"
      ...
      xml_accessor :operating_system_type, :as => DDEX::V20120404::DDEXC::OperatingSystemType, :from => "OperatingSystemType", :required => false
