...
require "ddex/v20120214/ddexc/release_relationship_type"
...
class RelatedRelease < Element
  ...
  xml_name "RelatedRelease"
      ...
      xml_accessor :release_summary_details_by_territories, :as => [DDEX::V20120214::DDEXC::ReleaseSummaryDetailsByTerritory], :from => "ReleaseSummaryDetailsByTerritory", :required => false

      xml_accessor :rights_agreement_id, :as => DDEX::V20120214::DDEXC::RightsAgreementId, :from => "RightsAgreementId", :required => false

      xml_accessor :release_relationship_type, :as => DDEX::V20120214::DDEXC::ReleaseRelationshipType, :from => "ReleaseRelationshipType", :required => true

      xml_accessor :release_date, :as => DDEX::V20120214::DDEXC::EventDate, :from => "ReleaseDate", :required => false
