...
require "ddex/ern/v43/sheet_music_id"
require "ddex/ern/v43/sheet_music_type"
require "ddex/ern/v43/technical_sheet_music_details"
require "ddex/ern/v43/version_type"
require "ddex/ern/v43/work_rights_controller"

module DDEX module ERN module V43  # :nodoc: all

class DDEX::ERN::V43::SheetMusic < Element
  include ROXML
  ...
  xml_name "SheetMusic"
      ...
      xml_accessor :type, :as => DDEX::ERN::V43::SheetMusicType, :from => "Type", :required => true
      xml_accessor :resource_ids, :as => [DDEX::ERN::V43::SheetMusicId], :from => "ResourceId", :required => true
      ...
      xml_accessor :technical_details, :as => [DDEX::ERN::V43::TechnicalSheetMusicDetails], :from => "TechnicalDetails", :required => false
