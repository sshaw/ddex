...
require "ddex/ern/v43/technical_text_details"
require "ddex/ern/v43/text_id"
require "ddex/ern/v43/text_type"
require "ddex/ern/v43/version_type"
require "ddex/ern/v43/work_rights_controller"

module DDEX module ERN module V43  # :nodoc: all

class DDEX::ERN::V43::Text < Element
  include ROXML
  ...
  xml_name "Text"
      ...
      xml_accessor :type, :as => DDEX::ERN::V43::TextType, :from => "Type", :required => true
      xml_accessor :resource_ids, :as => [DDEX::ERN::V43::TextId], :from => "ResourceId", :required => false
      ...
      xml_accessor :technical_details, :as => [DDEX::ERN::V43::TechnicalTextDetails], :from => "TechnicalDetails", :required => false
      xml_accessor :language_of_texts, :as => [DDEX::ERN::V43::Language], :from => "LanguageOfText", :required => false
