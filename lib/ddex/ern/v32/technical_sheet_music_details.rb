...
require "ddex/v20100712/ddexc/sheet_music_codec_type"

module DDEX module ERN module V32  # :nodoc: all

class DDEX::ERN::V32::TechnicalSheetMusicDetails < Element
  include ROXML
  ...
  xml_name "ns1:TechnicalSheetMusicDetails"
      ...
      xml_accessor :sheet_music_codec_type, :as => DDEX::V20100712::DDEXC::SheetMusicCodecType, :from => "SheetMusicCodecType", :required => false
