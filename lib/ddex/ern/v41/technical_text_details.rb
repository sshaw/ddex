...
require "ddex/ern/v41/text_codec_type"

module DDEX module ERN module V41  # :nodoc: all

class DDEX::ERN::V41::TechnicalTextDetails < Element
  include ROXML
  ...
  xml_name "TechnicalTextDetails"
      ...
      xml_accessor :text_codec_type, :as => DDEX::ERN::V41::TextCodecType, :from => "TextCodecType", :required => false
