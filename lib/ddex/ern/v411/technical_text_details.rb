...
require "ddex/ern/v411/text_codec_type"

module DDEX module ERN module V411  # :nodoc: all

class DDEX::ERN::V411::TechnicalTextDetails < Element
  include ROXML
  ...
  xml_name "TechnicalTextDetails"
      ...
      xml_accessor :text_codec_type, :as => DDEX::ERN::V411::TextCodecType, :from => "TextCodecType", :required => false
