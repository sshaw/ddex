...
require "ddex/ern/v383/text_details_by_territory"
require "ddex/ern/v383/text_id"
require "ddex/ern/v383/text_type"
require "ddex/ern/v383/title"

module DDEX module ERN module V383  # :nodoc: all

class DDEX::ERN::V383::Text < Element
  include ROXML


  xml_name "Text"

      xml_accessor :text_type, :as => DDEX::ERN::V383::TextType, :from => "TextType", :required => false
      xml_accessor :artist_related?, :from => "IsArtistRelated", :required => false
      xml_accessor :text_ids, :as => [DDEX::ERN::V383::TextId], :from => "TextId", :required => false
      xml_accessor :indirect_text_ids, :as => [DDEX::ERN::V383::MusicalWorkId], :from => "IndirectTextId", :required => false
      ...
      xml_accessor :text_details_by_territories, :as => [DDEX::ERN::V383::TextDetailsByTerritory], :from => "TextDetailsByTerritory", :required => true
