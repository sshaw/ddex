...
require "ddex/ern/v381/technical_user_defined_resource_details"
require "ddex/ern/v381/title"
require "ddex/ern/v381/user_defined_value"

module DDEX module ERN module V381  # :nodoc: all

class DDEX::ERN::V381::UserDefinedResourceDetailsByTerritory < Element
  include ROXML
  ...
  xml_name "ns1:UserDefinedResourceDetailsByTerritory"
      ...
      xml_accessor :technical_user_defined_resource_details, :as => [DDEX::ERN::V381::TechnicalUserDefinedResourceDetails], :from => "TechnicalUserDefinedResourceDetails", :required => false
