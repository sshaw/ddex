...
require "ddex/ern/v381/text_codec_type"

module DDEX module ERN module V381  # :nodoc: all

class DDEX::ERN::V381::TechnicalTextDetails < Element
  include ROXML
  ...
  xml_name "ns1:TechnicalTextDetails"
      ...
      xml_accessor :text_codec_type, :as => DDEX::ERN::V381::TextCodecType, :from => "TextCodecType", :required => false
