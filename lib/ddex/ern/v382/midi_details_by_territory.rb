...
class DDEX::ERN::V382::MidiDetailsByTerritory < Element
  ...
  xml_name "MidiDetailsByTerritory"
      ...
      xml_accessor :technical_midi_details, :as => [DDEX::ERN::V382::TechnicalMidiDetails], :from => "TechnicalMidiDetails", :required => false
