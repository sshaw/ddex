...
require "ddex/ern/v382/sheet_music_details_by_territory"
require "ddex/ern/v382/sheet_music_id"
require "ddex/ern/v382/sheet_music_type"

module DDEX module ERN module V382  # :nodoc: all

class DDEX::ERN::V382::SheetMusic < Element
  include ROXML


  xml_name "SheetMusic"

      xml_accessor :sheet_music_type, :as => DDEX::ERN::V382::SheetMusicType, :from => "SheetMusicType", :required => false
      xml_accessor :artist_related?, :from => "IsArtistRelated", :required => false
      xml_accessor :sheet_music_ids, :as => [DDEX::ERN::V382::SheetMusicId], :from => "SheetMusicId", :required => true
      xml_accessor :indirect_sheet_music_ids, :as => [DDEX::ERN::V382::MusicalWorkId], :from => "IndirectSheetMusicId", :required => false
      ...
      xml_accessor :sheet_music_details_by_territories, :as => [DDEX::ERN::V382::SheetMusicDetailsByTerritory], :from => "SheetMusicDetailsByTerritory", :required => true
