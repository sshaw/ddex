...
class DDEX::V20110120::DDEXC::CollectionId < Element
  ...
  xml_name "CollectionId"
      ...
      xml_accessor :icpn, :as => DDEX::V20110120::DDEXC::ICPN, :from => "ICPN", :required => false
