...
require "ddex/ern/v381/technical_sheet_music_details"
require "ddex/ern/v381/title"

module DDEX module ERN module V381  # :nodoc: all

class DDEX::ERN::V381::SheetMusicDetailsByTerritory < Element
  include ROXML
  ...
  xml_name "SheetMusicDetailsByTerritory"
      ...
      xml_accessor :technical_sheet_music_details, :as => [DDEX::ERN::V381::TechnicalSheetMusicDetails], :from => "TechnicalSheetMusicDetails", :required => false
