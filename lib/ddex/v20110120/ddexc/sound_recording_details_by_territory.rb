...
class DDEX::V20110120::DDEXC::SoundRecordingDetailsByTerritory < Element
  include ROXML
  ...
  xml_name "SoundRecordingDetailsByTerritory"
      ...
      xml_accessor :remastered_date, :as => DDEX::V20110120::DDEXC::EventDate, :from => "RemasteredDate", :required => false
