...
require "ddex/v20110120/ddexc/video_details_by_territory"
require "ddex/v20110120/ddexc/video_id"
require "ddex/v20110120/ddexc/video_type"

module DDEX module V20110120 module DDEXC  # :nodoc: all

class DDEX::V20110120::DDEXC::Video < Element
  include ROXML


  xml_name "Video"

      xml_accessor :video_type, :as => DDEX::V20110120::DDEXC::VideoType, :from => "VideoType", :required => false
      xml_accessor :artist_related?, :from => "IsArtistRelated", :required => false
      xml_accessor :video_ids, :as => [DDEX::V20110120::DDEXC::VideoId], :from => "VideoId", :required => false
      xml_accessor :indirect_video_ids, :as => [DDEX::V20110120::DDEXC::MusicalWorkId], :from => "IndirectVideoId", :required => false
      ...
      xml_accessor :video_details_by_territories, :as => [DDEX::V20110120::DDEXC::VideoDetailsByTerritory], :from => "VideoDetailsByTerritory", :required => true
