...
require "ddex/v20110120/ddexc/sheet_music_details_by_territory"
require "ddex/v20110120/ddexc/sheet_music_id"
require "ddex/v20110120/ddexc/sheet_music_type"

module DDEX module V20110120 module DDEXC  # :nodoc: all

class DDEX::V20110120::DDEXC::SheetMusic < Element
  include ROXML


  xml_name "SheetMusic"

      xml_accessor :sheet_music_type, :as => DDEX::V20110120::DDEXC::SheetMusicType, :from => "SheetMusicType", :required => false
      xml_accessor :artist_related?, :from => "IsArtistRelated", :required => false
      xml_accessor :sheet_music_ids, :as => [DDEX::V20110120::DDEXC::SheetMusicId], :from => "SheetMusicId", :required => true
      xml_accessor :indirect_sheet_music_ids, :as => [DDEX::V20110120::DDEXC::MusicalWorkId], :from => "IndirectSheetMusicId", :required => false
      ...
      xml_accessor :sheet_music_details_by_territories, :as => [DDEX::V20110120::DDEXC::SheetMusicDetailsByTerritory], :from => "SheetMusicDetailsByTerritory", :required => true
