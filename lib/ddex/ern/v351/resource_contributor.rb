...
require "ddex/v20121219/ddexc/artist_delegated_usage_rights"
require "ddex/v20121219/ddexc/artist_role"
require "ddex/v20121219/ddexc/artist_role"
require "ddex/v20121219/ddexc/contact_id"
require "ddex/v20121219/ddexc/event_date"
require "ddex/v20121219/ddexc/event_date"
require "ddex/v20121219/ddexc/genre"
require "ddex/v20121219/ddexc/governing_agreement_type"
require "ddex/v20121219/ddexc/membership"
...
class ResourceContributor < Element
  ...
  xml_name "ResourceContributor"
      ...
      xml_accessor :artist_delegated_usage_rights, :as => DDEX::V20121219::DDEXC::ArtistDelegatedUsageRights, :from => "ArtistDelegatedUsageRights", :required => false

      xml_accessor :sex, :from => "Sex", :required => false

      xml_accessor :date_and_place_of_birth, :as => DDEX::V20121219::DDEXC::EventDate, :from => "DateAndPlaceOfBirth", :required => false

      xml_accessor :date_and_place_of_death, :as => DDEX::V20121219::DDEXC::EventDate, :from => "DateAndPlaceOfDeath", :required => false

      xml_accessor :primary_role, :as => DDEX::V20121219::DDEXC::ArtistRole, :from => "PrimaryRole", :required => false

      xml_accessor :primary_instrument_type, :from => "PrimaryInstrumentType", :required => false

      xml_accessor :governing_agreement_type, :as => DDEX::V20121219::DDEXC::GoverningAgreementType, :from => "GoverningAgreementType", :required => false

      xml_accessor :contact_information, :as => DDEX::V20121219::DDEXC::ContactId, :from => "ContactInformation", :required => false

      xml_accessor :territory_of_residency, :from => "TerritoryOfResidency", :required => false

      
      xml_accessor :additional_roles, :as => [DDEX::V20121219::DDEXC::ArtistRole], :from => "AdditionalRoles", :required => false

      
      xml_accessor :genres, :as => [DDEX::V20121219::DDEXC::Genre], :from => "Genre", :required => false

      
      xml_accessor :memberships, :as => [DDEX::V20121219::DDEXC::Membership], :from => "Membership", :required => false
