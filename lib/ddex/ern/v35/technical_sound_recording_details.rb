...
class TechnicalSoundRecordingDetails < Element
  ...
  xml_name "TechnicalSoundRecordingDetails"
      ...
      xml_accessor :bit_rate, :as => DDEX::V20120719::DDEXC::BitRate, :from => "BitRate", :required => false
      xml_accessor :number_of_channels, :as => Integer, :from => "NumberOfChannels", :required => false
      xml_accessor :sampling_rate, :as => DDEX::V20120719::DDEXC::SamplingRate, :from => "SamplingRate", :required => false
