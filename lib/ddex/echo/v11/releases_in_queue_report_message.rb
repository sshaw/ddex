...
require "ddex/echo/v11/release_in_queue_list"
require "ddex/echo/v11/report_message_header"

module DDEX module ECHO module V11  # :nodoc: all

class ReleasesInQueueReportMessage < Element
  include ROXML

    setns "echo", "http://ddex.net/xml/2011/echo/11"

  xml_name "ReleasesInQueueReportMessage"

      xml_accessor :message_header, :as => DDEX::ECHO::V11::ReportMessageHeader, :from => "MessageHeader", :required => true
      xml_accessor :release_in_queue_list, :as => DDEX::ECHO::V11::ReleaseInQueueList, :from => "ReleaseInQueueList", :required => false
