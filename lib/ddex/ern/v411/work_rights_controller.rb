...
require "ddex/ern/v411/all_territory_code"

module DDEX module ERN module V411  # :nodoc: all

class DDEX::ERN::V411::WorkRightsController < Element
  include ROXML
  ...
  xml_name "WorkRightsController"
      ...
      xml_accessor :territories, :as => [DDEX::ERN::V411::AllTerritoryCode], :from => "Territory", :required => false
