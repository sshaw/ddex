...
class DDEX::ERN::V41::Software < Element
  ...
  xml_name "Software"
      ...
      xml_accessor :type, :as => DDEX::ERN::V41::SoftwareType, :from => "Type", :required => true
      ...
      xml_accessor :technical_details, :as => [DDEX::ERN::V41::TechnicalSoftwareDetails], :from => "TechnicalDetails", :required => false
