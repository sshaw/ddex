...
require "ddex/v20121219/ddexc/right_share_creation_reference_list"
require "ddex/v20121219/ddexc/rights_agreement_id"
require "ddex/v20121219/ddexc/rights_controller"
require "ddex/v20121219/ddexc/rights_type"
require "ddex/v20121219/ddexc/tariff_reference"
...
class RightShare < Element
  ...
  xml_name "RightShare"
      ...
      xml_accessor :right_share_id, :as => DDEX::V20121219::DDEXC::RightsAgreementId, :from => "RightShareId", :required => false

      xml_accessor :right_share_reference, :from => "RightShareReference", :required => true

      xml_accessor :right_share_creation_reference_list, :as => DDEX::V20121219::DDEXC::RightShareCreationReferenceList, :from => "RightShareCreationReferenceList", :required => false
      ...
      xml_accessor :use_types, :as => [DDEX::V20121219::DDEXC::UseType], :from => "UseType", :required => false
      ...
      xml_accessor :rights_controllers, :as => [DDEX::V20121219::DDEXC::RightsController], :from => "RightsController", :required => false

      xml_accessor :validity_period, :as => DDEX::V20121219::DDEXC::Period, :from => "ValidityPeriod", :required => true
      ...
      xml_accessor :tariff_reference, :as => DDEX::V20121219::DDEXC::TariffReference, :from => "TariffReference", :required => false
