...
class DDEX::ERN::V381::VideoDetailsByTerritory < Element
  ...
  xml_name "ns1:VideoDetailsByTerritory"
      ...
      xml_accessor :technical_video_details, :as => [DDEX::ERN::V381::TechnicalVideoDetails], :from => "TechnicalVideoDetails", :required => false
