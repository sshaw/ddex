...
require "ddex/ern/v382/text_details_by_territory"
require "ddex/ern/v382/text_id"
require "ddex/ern/v382/text_type"
require "ddex/ern/v382/title"

module DDEX module ERN module V382  # :nodoc: all

class DDEX::ERN::V382::Text < Element
  include ROXML


  xml_name "Text"

      xml_accessor :text_type, :as => DDEX::ERN::V382::TextType, :from => "TextType", :required => false
      xml_accessor :artist_related?, :from => "IsArtistRelated", :required => false
      xml_accessor :text_ids, :as => [DDEX::ERN::V382::TextId], :from => "TextId", :required => false
      xml_accessor :indirect_text_ids, :as => [DDEX::ERN::V382::MusicalWorkId], :from => "IndirectTextId", :required => false
      ...
      xml_accessor :text_details_by_territories, :as => [DDEX::ERN::V382::TextDetailsByTerritory], :from => "TextDetailsByTerritory", :required => true
