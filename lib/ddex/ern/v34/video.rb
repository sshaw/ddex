...
require "ddex/ern/v34/video_details_by_territory"
...
require "ddex/v20120214/ddexc/sound_recording_collection_reference_list"
require "ddex/v20120214/ddexc/title"
require "ddex/v20120214/ddexc/video_cue_sheet_reference"
...
class Video < Element
  ...
  xml_name "Video"
      ...
      xml_accessor :video_type, :as => DDEX::V20120214::DDEXC::VideoType, :from => "VideoType", :required => false

      xml_accessor :artist_related?, :from => "IsArtistRelated", :required => false

      
      xml_accessor :video_ids, :as => [DDEX::V20120214::DDEXC::VideoId], :from => "VideoId", :required => false

      
      xml_accessor :indirect_video_ids, :as => [DDEX::V20120214::DDEXC::MusicalWorkId], :from => "IndirectVideoId", :required => false

      xml_accessor :resource_reference, :from => "ResourceReference", :required => true

      xml_accessor :reason_for_cue_sheet_absence, :as => DDEX::V20120214::DDEXC::Reason, :from => "ReasonForCueSheetAbsence", :required => false

      
      xml_accessor :video_cue_sheet_references, :as => [DDEX::V20120214::DDEXC::VideoCueSheetReference], :from => "VideoCueSheetReference", :required => false

      xml_accessor :reference_title, :as => DDEX::V20120214::DDEXC::ReferenceTitle, :from => "ReferenceTitle", :required => false

      
      xml_accessor :titles, :as => [DDEX::V20120214::DDEXC::Title], :from => "Title", :required => false

      xml_accessor :instrumentation_description, :as => DDEX::V20120214::DDEXC::Description, :from => "InstrumentationDescription", :required => false
      ...
      xml_accessor :video_collection_reference_list, :as => DDEX::V20120214::DDEXC::SoundRecordingCollectionReferenceList, :from => "VideoCollectionReferenceList", :required => false
      ...
      xml_accessor :mastered_date, :as => DDEX::V20120214::DDEXC::EventDate, :from => "MasteredDate", :required => false

      
      xml_accessor :video_details_by_territories, :as => [DDEX::ERN::V34::VideoDetailsByTerritory], :from => "VideoDetailsByTerritory", :required => true
