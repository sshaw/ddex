...
require "ddex/ern/v37/technical_text_details"
...
class TextDetailsByTerritory < Element
  ...
  xml_name "TextDetailsByTerritory"
      ...
      xml_accessor :technical_text_details, :as => [DDEX::ERN::V37::TechnicalTextDetails], :from => "TechnicalTextDetails", :required => false
