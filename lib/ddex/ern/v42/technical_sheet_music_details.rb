...
require "ddex/ern/v42/sheet_music_codec_type"

module DDEX module ERN module V42  # :nodoc: all

class DDEX::ERN::V42::TechnicalSheetMusicDetails < Element
  include ROXML
  ...
  xml_name "TechnicalSheetMusicDetails"
      ...
      xml_accessor :sheet_music_codec_type, :as => DDEX::ERN::V42::SheetMusicCodecType, :from => "SheetMusicCodecType", :required => false
