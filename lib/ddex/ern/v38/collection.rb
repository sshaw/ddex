...
require "ddex/ern/v38/collection_collection_reference_list"
require "ddex/ern/v38/collection_details_by_territory"
require "ddex/ern/v38/collection_id"
require "ddex/ern/v38/collection_resource_reference_list"
require "ddex/ern/v38/collection_type"
require "ddex/ern/v38/collection_work_reference_list"
...
class DDEX::ERN::V38::Collection < Element
  include ROXML
  ...
  xml_name "ns1:Collection"
      ...
      xml_accessor :collection_collection_reference_list, :as => DDEX::ERN::V38::CollectionCollectionReferenceList, :from => "CollectionCollectionReferenceList", :required => false
      ...
      xml_accessor :collection_details_by_territories, :as => [DDEX::ERN::V38::CollectionDetailsByTerritory], :from => "CollectionDetailsByTerritory", :required => false
      xml_accessor :collection_resource_reference_list, :as => DDEX::ERN::V38::CollectionResourceReferenceList, :from => "CollectionResourceReferenceList", :required => false
      xml_accessor :collection_work_reference_list, :as => DDEX::ERN::V38::CollectionWorkReferenceList, :from => "CollectionWorkReferenceList", :required => false
