...
require "ddex/ern/v382/sheet_music_codec_type"

module DDEX module ERN module V382  # :nodoc: all

class DDEX::ERN::V382::TechnicalSheetMusicDetails < Element
  include ROXML
  ...
  xml_name "TechnicalSheetMusicDetails"
      ...
      xml_accessor :sheet_music_codec_type, :as => DDEX::ERN::V382::SheetMusicCodecType, :from => "SheetMusicCodecType", :required => false
