...
require "ddex/ern/v43/purpose"

module DDEX module ERN module V43  # :nodoc: all

class DDEX::ERN::V43::ResourceContainedResourceReference < Element
  include ROXML
  ...
  xml_name "ResourceContainedResourceReference"
      ...
      xml_accessor :purpose, :as => DDEX::ERN::V43::Purpose, :from => "Purpose", :required => false
