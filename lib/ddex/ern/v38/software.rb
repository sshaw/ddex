...
require "ddex/ern/v38/software_details_by_territory"
require "ddex/ern/v38/software_type"
require "ddex/ern/v38/title"

module DDEX module ERN module V38  # :nodoc: all

class DDEX::ERN::V38::Software < Element
  include ROXML
  ...
  xml_name "Software"
      ...
      xml_accessor :software_ids, :as => [DDEX::ERN::V38::ResourceProprietaryId], :from => "SoftwareId", :required => true
      xml_accessor :indirect_software_ids, :as => [DDEX::ERN::V38::MusicalWorkId], :from => "IndirectSoftwareId", :required => false
      ...
      xml_accessor :software_details_by_territories, :as => [DDEX::ERN::V38::SoftwareDetailsByTerritory], :from => "SoftwareDetailsByTerritory", :required => true
