...
require "ddex/ern/v381/technical_image_details"
require "ddex/ern/v381/title"

module DDEX module ERN module V381  # :nodoc: all

class DDEX::ERN::V381::ImageDetailsByTerritory < Element
  include ROXML
  ...
  xml_name "ns1:ImageDetailsByTerritory"
      ...
      xml_accessor :technical_image_details, :as => [DDEX::ERN::V381::TechnicalImageDetails], :from => "TechnicalImageDetails", :required => false
