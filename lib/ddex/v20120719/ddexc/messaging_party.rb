...
class MessagingParty < Element
  ...
  xml_name "MessagingParty"
      ...
      xml_accessor :party_id, :as => DDEX::V20120719::DDEXC::PartyId, :from => "PartyId", :required => true

      xml_accessor :party_name, :as => DDEX::V20120719::DDEXC::PartyName, :from => "PartyName", :required => false
