...
require "ddex/ern/v42/fingerprint_algorithm_type"

module DDEX module ERN module V42  # :nodoc: all

class DDEX::ERN::V42::Fingerprint < Element
  include ROXML


  xml_name "Fingerprint"

      xml_accessor :algorithm, :as => DDEX::ERN::V42::FingerprintAlgorithmType, :from => "Algorithm", :required => true
