...
and variations {do exist in the wild}[https://github.com/sshaw/ddex/pull/2#issue-30059145]. If you're dealing with
<code>MessageSchemaVersionId</code>s that vary from this format (TODO: note normalization?), and explicitly setting
the version is not practical, you can set the global default(s):
  ...
  DDEX::ERN.config["V351"][:message_schema_version_id] = "ern/35punto1"
  # ...
...
be modified to accommodate something other than <code>SPEC/VERSION</code> out of the box.
