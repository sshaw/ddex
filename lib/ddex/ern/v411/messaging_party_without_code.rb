...
require "ddex/ern/v411/party_name_without_code"

module DDEX module ERN module V411  # :nodoc: all

class DDEX::ERN::V411::MessagingPartyWithoutCode < Element
  include ROXML
  ...
  xml_name "MessagingPartyWithoutCode"
      ...
      xml_accessor :party_name, :as => DDEX::ERN::V411::PartyNameWithoutCode, :from => "PartyName", :required => false
