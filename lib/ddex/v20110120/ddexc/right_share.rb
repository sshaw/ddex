...
require "ddex/v20110120/ddexc/commercial_model_type"
require "ddex/v20110120/ddexc/distribution_channel_type"
require "ddex/v20110120/ddexc/period"
require "ddex/v20110120/ddexc/right_share_creation_reference_list"
require "ddex/v20110120/ddexc/rights_agreement_id"
require "ddex/v20110120/ddexc/rights_controller"
require "ddex/v20110120/ddexc/rights_type"
require "ddex/v20110120/ddexc/tariff_reference"
...
class DDEX::V20110120::DDEXC::RightShare < Element
  include ROXML


  xml_name "RightShare"

      xml_accessor :right_share_id, :as => DDEX::V20110120::DDEXC::RightsAgreementId, :from => "RightShareId", :required => false
      xml_accessor :right_share_reference, :from => "RightShareReference", :required => true
      xml_accessor :right_share_creation_reference_list, :as => DDEX::V20110120::DDEXC::RightShareCreationReferenceList, :from => "RightShareCreationReferenceList", :required => false
      ...
      xml_accessor :use_types, :as => [DDEX::V20110120::DDEXC::UseType], :from => "UseType", :required => false
      ...
      xml_accessor :commercial_model_types, :as => [DDEX::V20110120::DDEXC::CommercialModelType], :from => "CommercialModelType", :required => false
      xml_accessor :musical_work_rights_claim_types, :from => "MusicalWorkRightsClaimType", :required => false
      xml_accessor :rights_controllers, :as => [DDEX::V20110120::DDEXC::RightsController], :from => "RightsController", :required => false
      xml_accessor :validity_period, :as => DDEX::V20110120::DDEXC::Period, :from => "ValidityPeriod", :required => true
      ...
      xml_accessor :tariff_reference, :as => DDEX::V20110120::DDEXC::TariffReference, :from => "TariffReference", :required => false
