...
require "ddex/ern/v41/sheet_music_codec_type"

module DDEX module ERN module V41  # :nodoc: all

class DDEX::ERN::V41::TechnicalSheetMusicDetails < Element
  include ROXML
  ...
  xml_name "TechnicalSheetMusicDetails"
      ...
      xml_accessor :sheet_music_codec_type, :as => DDEX::ERN::V41::SheetMusicCodecType, :from => "SheetMusicCodecType", :required => false
