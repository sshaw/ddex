...
require "ddex/ern/v38/sheet_music_details_by_territory"
require "ddex/ern/v38/sheet_music_id"
require "ddex/ern/v38/sheet_music_type"

module DDEX module ERN module V38  # :nodoc: all

class DDEX::ERN::V38::SheetMusic < Element
  include ROXML
  ...
  xml_name "SheetMusic"
      ...
      xml_accessor :sheet_music_ids, :as => [DDEX::ERN::V38::SheetMusicId], :from => "SheetMusicId", :required => true
      xml_accessor :indirect_sheet_music_ids, :as => [DDEX::ERN::V38::MusicalWorkId], :from => "IndirectSheetMusicId", :required => false
      ...
      xml_accessor :sheet_music_details_by_territories, :as => [DDEX::ERN::V38::SheetMusicDetailsByTerritory], :from => "SheetMusicDetailsByTerritory", :required => true
