...
require "ddex/v20120214/ddexc/musical_work_contributor_role"
require "ddex/v20120214/ddexc/party_id"
require "ddex/v20120214/ddexc/party_name"
require "ddex/v20120214/ddexc/society_affiliation"
...
class MusicalWorkContributor < Element
  ...
  xml_name "MusicalWorkContributor"
      ...
      xml_accessor :musical_work_contributor_roles, :as => [DDEX::V20120214::DDEXC::MusicalWorkContributorRole], :from => "MusicalWorkContributorRole", :required => false

      
      xml_accessor :society_affiliations, :as => [DDEX::V20120214::DDEXC::SocietyAffiliation], :from => "SocietyAffiliation", :required => false
