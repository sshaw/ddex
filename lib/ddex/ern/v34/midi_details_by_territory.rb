...
require "ddex/ern/v34/technical_midi_details"
...
class MidiDetailsByTerritory < Element
  ...
  xml_name "MidiDetailsByTerritory"
      ...
      xml_accessor :technical_midi_details, :as => [DDEX::ERN::V34::TechnicalMidiDetails], :from => "TechnicalMidiDetails", :required => false
