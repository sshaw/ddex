...
require "ddex/ern/v34/sound_recording_preview_details"
require "ddex/v20120214/ddexc/audio_codec_type"
...
require "ddex/v20120214/ddexc/frame_rate"
...
class TechnicalVideoDetails < Element
  ...
  xml_name "TechnicalVideoDetails"
      ...
      xml_accessor :overall_bit_rate, :as => DDEX::V20120214::DDEXC::BitRate, :from => "OverallBitRate", :required => false

      xml_accessor :container_format, :as => DDEX::V20120214::DDEXC::ContainerFormat, :from => "ContainerFormat", :required => false

      xml_accessor :video_codec_type, :as => DDEX::V20120214::DDEXC::VideoCodecType, :from => "VideoCodecType", :required => false

      xml_accessor :video_bit_rate, :as => DDEX::V20120214::DDEXC::BitRate, :from => "VideoBitRate", :required => false

      xml_accessor :frame_rate, :as => DDEX::V20120214::DDEXC::FrameRate, :from => "FrameRate", :required => false
      ...
      xml_accessor :audio_codec_type, :as => DDEX::V20120214::DDEXC::AudioCodecType, :from => "AudioCodecType", :required => false

      xml_accessor :audio_bit_rate, :as => DDEX::V20120214::DDEXC::BitRate, :from => "AudioBitRate", :required => false

      xml_accessor :number_of_audio_channels, :as => Fixnum, :from => "NumberOfAudioChannels", :required => false

      xml_accessor :audio_sampling_rate, :as => DDEX::V20120214::DDEXC::SamplingRate, :from => "AudioSamplingRate", :required => false
      ...
      xml_accessor :preview_details, :as => DDEX::ERN::V34::SoundRecordingPreviewDetails, :from => "PreviewDetails", :required => false
