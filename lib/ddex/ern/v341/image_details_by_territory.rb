...
require "ddex/ern/v341/technical_image_details"
...
class ImageDetailsByTerritory < Element
  ...
  xml_name "ImageDetailsByTerritory"
      ...
      xml_accessor :technical_image_details, :as => [DDEX::ERN::V341::TechnicalImageDetails], :from => "TechnicalImageDetails", :required => false
