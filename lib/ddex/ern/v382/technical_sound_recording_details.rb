...
class DDEX::ERN::V382::TechnicalSoundRecordingDetails < Element
  include ROXML
  ...
  xml_name "TechnicalSoundRecordingDetails"
      ...
      xml_accessor :bit_rate, :as => DDEX::ERN::V382::BitRate, :from => "BitRate", :required => false
      xml_accessor :number_of_channels, :as => Integer, :from => "NumberOfChannels", :required => false
      xml_accessor :sampling_rate, :as => DDEX::ERN::V382::SamplingRate, :from => "SamplingRate", :required => false
