...
require "ddex/ern/v43/image_codec_type"

module DDEX module ERN module V43  # :nodoc: all

class DDEX::ERN::V43::TechnicalImageDetails < Element
  include ROXML
  ...
  xml_name "TechnicalImageDetails"
      ...
      xml_accessor :image_codec_type, :as => DDEX::ERN::V43::ImageCodecType, :from => "ImageCodecType", :required => false
