...
require "ddex/ern/v341/technical_midi_details"
...
class MidiDetailsByTerritory < Element
  ...
  xml_name "MidiDetailsByTerritory"
      ...
      xml_accessor :technical_midi_details, :as => [DDEX::ERN::V341::TechnicalMidiDetails], :from => "TechnicalMidiDetails", :required => false
