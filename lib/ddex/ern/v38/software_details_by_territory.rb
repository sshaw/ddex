...
require "ddex/ern/v38/technical_software_details"
require "ddex/ern/v38/title"

module DDEX module ERN module V38  # :nodoc: all

class DDEX::ERN::V38::SoftwareDetailsByTerritory < Element
  include ROXML
  ...
  xml_name "SoftwareDetailsByTerritory"
      ...
      xml_accessor :technical_software_details, :as => [DDEX::ERN::V38::TechnicalSoftwareDetails], :from => "TechnicalSoftwareDetails", :required => false
