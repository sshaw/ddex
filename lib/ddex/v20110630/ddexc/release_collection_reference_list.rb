...
require "ddex/v20110630/ddexc/release_collection_reference"
...
class ReleaseCollectionReferenceList < Element
  ...
  xml_name "ReleaseCollectionReferenceList"
      ...
      xml_accessor :release_collection_references, :as => [DDEX::V20110630::DDEXC::ReleaseCollectionReference], :from => "ReleaseCollectionReference", :required => true
